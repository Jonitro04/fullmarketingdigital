...
<div class="container">
    ...
    <div class="one_third"><div class="circle_img"></div></div><!-- end section -->
...
<div class="container">
    ...
    <div class="one_fourth">
    	<div class="skillgraph one"><i class="fa fa-leaf"></i></div> <h4 class="nocaps">UI/UX Design</h4>
	</div><!-- end section -->
    
    <div class="one_fourth">
    	<div class="skillgraph two"><i class="fa fa-laptop"></i></div> <h4 class="nocaps">Development</h4>
	</div><!-- end section -->
    
    <div class="one_fourth">
    	<div class="skillgraph three"><i class="fa fa-code"></i></div> <h4 class="nocaps">Javascript</h4>
	</div><!-- end section -->
    
    <div class="one_fourth last">
    	<div class="skillgraph four"><i class="fa fa-coffee"></i></div> <h4 class="nocaps">Graphic Design</h4>
	</div><!-- end section -->

</div>
</div><!-- end features section45 -->
                            ...
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        ...
                                        <br />
                                        <a href="portfolio-one.html" class="portfolioicons"><i class="fa fa-link"></i></a>
                                        <a href="http://placehold.it/800x600" class="cbp-lightbox portfolioicons" data-title="Events and  More<br>by Tiberiu Neamu"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="container">
	...
	<div class="clearfix divider_dashed4"></div><!-- end divider line -->

    <div class="one_third">
    	
        <h3 class="ipages_title1"><strong>what</strong> i do?</h3>
    ...
    <div class="one_third last">
		...
		<h3 class="ipages_title1"><strong>S'inscrire à </strong> Mail-o-clic</h3>
        
                <button class="readmore_but8"><a href="/contact"><strong>Mail-o-Clic</strong></a></button>
