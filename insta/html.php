...
<!-- just remove the below comments witch bg patterns you want to use --> 
    ...
    <!-- REVOLUTION SLIDER -->
   	<link rel="stylesheet" type="text/css" href="web/js/revolutionslider/rs-plugin/css/settings.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="web/js/revolutionslider/css/slider_main.css" media="screen" />
    
    <!-- cubeportfolio -->
	<link rel="stylesheet" type="text/css" href="web/js/cubeportfolio/cubeportfolio.min.css">
    
	<!-- tabs -->
    <link rel="stylesheet" type="text/css" href="web/js/tabs/assets/css/responsive-tabs.css">
    <link rel="stylesheet" type="text/css" href="web/js/tabs/assets/css/responsive-tabs2.css">
    <link rel="stylesheet" type="text/css" href="web/js/tabs/assets/css/responsive-tabs3.css">

	<!-- carousel -->
    <link rel="stylesheet" href="web/js/carousel/flexslider.css" type="text/css" media="screen" />
 	<link rel="stylesheet" type="text/css" href="web/js/carousel/skin.css" />
    
	<!-- progressbar -->
  	<link rel="stylesheet" href="web/js/progressbar/ui.progress-bar.css">
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <div class="tp-caption slider_but2 sfb"
						...
						data-endeasing="Power1.easeIn"
						data-captionhidden="off"
						style="z-index: 6"><a href="#">Purchase Now!</a>
					</div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <div class="tp-caption bigtext sfb"
						...
						data-endeasing="Power1.easeIn"
						data-captionhidden="off"
						style="z-index: 6">Responsive <strong>Layout</strong>
					</div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <div class="tp-caption bigtext sfb"
						...
						data-endeasing="Power1.easeIn"
						data-captionhidden="off"
						style="z-index: 6">10 Home <strong>Versions</strong>
					</div>
...
<div class="container">
      ...
      <h2 class="section_title_white"><strong>latest</strong> projects</h2>
    
      <div id="grid-container" class="cbp-l-grid-fullScreen">
        <ul>
          <li class="cbp-item identity logo"> <a href="http://placehold.it/800x600" class="cbp-caption cbp-lightbox" data-title="Consectetuer Adipiscing<br>by GSRthemes9">
          ...
          <li class="cbp-item"> <a href="http://placehold.it/800x600" class="cbp-caption cbp-lightbox" data-title="Many Websites Infancy<br>by GSRthemes9">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x600" alt="" /> </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignLeft">
                <div class="cbp-l-caption-body">
          ...
          <li class="cbp-item motion graphic"> <a href="http://placehold.it/800x600" class="cbp-caption cbp-lightbox" data-title="Words Believable<br>by GSRthemes9">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x600" alt="" /> </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignLeft">
                <div class="cbp-l-caption-body">
          ...
          <li class="cbp-item identity"> <a href="http://placehold.it/800x600" class="cbp-caption cbp-lightbox" data-title="Therefore Always Free<br>by GSRthemes9">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x600" alt="" /> </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignLeft">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Therefore Always Free</div>
                  <div class="cbp-l-caption-desc">Rutrum adipiscing luctus</div>
                </div>
              </div>
            </div>
...
<div class="container">
	...
	<div class="rightsection">
        ...
        <ul>
            ...
            <li class="text"><h3 class="nocaps">User Research</h3> <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue.</p></li>
        </ul>
        
        <ul class="two active">
        	<li class="icon"><i class="fa fa-leaf"></i></li>
            <li class="text"><h3 class="nocaps">Wireframes and Design</h3> <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue.</p></li>
        </ul>
        
        <ul class="three">
        	<li class="icon"><i class="fa fa-cog"></i></li>
            <li class="text"><h3 class="nocaps">Development and Testing</h3> <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue.</p></li>
        </ul>
...
<div class="container">
    ...
    <div class="two_third">
   	<div class="clearfix margin_top7"></div>
        ...
        <div id="demo-tab-2" class="tabs-panel">
            ...
            <img src="images/site-img2.jpg" alt="" class="img_left1" />
        ...
        <div id="demo-tab-3" class="tabs-panel">
            ...
            <img src="images/site-img3.jpg" alt="" class="img_left2" />
        ...
        <div id="demo-tab-5" class="tabs-panel">
            ...
            <h3>Recently desktop publishing software</h3>
            <img src="images/site-img4.jpg" alt="" class="img_left1" />
    ...
    <div class="one_third last"><img src="http://placehold.it/310x470" alt="" /></div><!-- end right side image -->
...
<div class="container">
    ...
    <div class="root">
        ...
        <div class="one_fifth"><i class="fa fa-cloud"></i> <h5>Product Backlog</h5></div>
        
        <div class="one_fifth"><i class="fa fa-asterisk active"></i> <h5>Sprint Backlog</h5></div>
        
        <div class="one_fifth"><i class="fa fa-user"></i> <h5>User Stories</h5></div>
        
        <div class="one_fifth"><i class="fa fa-desktop"></i> <h5>Demo</h5></div>
        
        <div class="one_fifth last"><i class="fa fa-rocket"></i> <h5>Deliverables</h5></div>
...
<div class="container">
	...
	<div class="two_third">
        ...
        <br />
        <span>Cras dapibus orci rutrum adipiscing luctus, nisl magna tempus urna, id porttitor <br /> nuncarcuet mauris. Suspendisse <i class="fa fa-long-arrow-left fa-lg img_right"></i></span>
        
        <span class="clearfix divider_dashed1"></span>
        
        <a href="#" class="readmore_but3 img_left3">Learn more</a> <a href="#" class="readmore_but4">purchase now!</a>
              
    </div><!-- end section -->
    
    <div class="one_third last"><img src="http://placehold.it/390x580" alt="" class="img_right" /></div><!-- end right image -->
...
<div class="container">
    ...
    <br /><br />
    <a href="#" class="readmore_but2">Purchase now</a>
    </div>
...
<div class="container">
    ...
    <div class="one_fourth">
        ...
        <div class="box">
            ...
            <div class="text">
                <div><h4>Design</h4> Lorem ipsum dolor sit amet, consectetuer  elit. Suspen disse et justo.</div>
            </div>
        </div>
    ...
    <div class="one_fourth">
        ...
        <div class="box">
            ...
            <div class="text">
                <div><h4>Devolopment</h4> Lorem ipsum dolor sit amet, consectetuer  elit. Suspen disse et justo.</div>
            </div>
        </div>
    ...
    <div class="one_fourth">
        ...
        <div class="box">
            ...
            <div class="text">
                <div><h4>Branding</h4> Lorem ipsum dolor sit amet, consectetuer  elit. Suspen disse et justo.</div>
            </div>
        </div>
...
</div><!-- end features section9 -->

<div class="clearfix"></div>

<div class="features_sec10">
<div class="container">

	<h2 class="section_title_drakgray nomarb"><strong>Our</strong> Clints says</h2>
          ...
          <ul class="slides">
                ...
                <div class="diamond">
                    ...
                    <div class="content_div">
                        ...
                        <h2>Marison Avasa</h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting it has the randomised words which standard have evoved over the years.</p>
                        <br />
                        <a href="#" class="readmore_but5">Read more</a>
                ...
                <div class="diamond">
                    ...
                    <div class="content_div">
                        ...
                        <div class="client_img three"></div>
                        <h2>Alphonse Ria</h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting it has the randomised words which standard have evoved over the years.</p>
                        <br />
                        <a href="#" class="readmore_but5">Read more</a>
...
<div class="container">
	...
	<h2 class="section_title_drakgray"><strong>Recent</strong> Blogs</h2>
    ...
    <div class="hblog">
        ...
        <div class="content2">
        <h5>Consectetuer adipiscins</h5>
        <span class="date">by john Doe | 12 Feb, 2014</span>
        <span class="comments"><i class="fa fa-comment"></i> <a href="#">27 comments</a> &nbsp;&nbsp;<i class="fa fa-user"></i> <a href="#">gsrthemes9</a></span>
        <p>Many desktop publishing packages in web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.</p>
        </div>
    ...
    <div class="one_third">
    <div class="hblog active">
    
    	<img src="http://placehold.it/360x250" alt="" />
        
        <div class="content2">
        <h5>Normal distribute letters</h5>
        <span class="date">by john Doe | 11 Feb, 2014</span>
        <span class="comments"><i class="fa fa-comment"></i> <a href="#">18 comments</a> &nbsp;&nbsp;<i class="fa fa-user"></i> <a href="#">gsrthemes9</a></span>
        <p>Many desktop publishing packages in web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.</p>
        </div>
    ...
    <div class="hblog">
        ...
        <div class="content2">
        <h5>Generator on the Internet</h5>
        <span class="date">by john Doe | 10 Feb, 2014</span>
        <span class="comments"><i class="fa fa-comment"></i> <a href="#">09 comments</a> &nbsp;&nbsp;<i class="fa fa-user"></i> <a href="#">gsrthemes9</a></span>
        <p>Many desktop publishing packages in web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum will uncover many web sites still in their infancy.</p>
        </div>
...
<div class="container">
	...
	<h2 class="section_title_drakgray lessmar"><strong>Amazing</strong> Package</h2>
    ...
    <div class="center">
        ...
        <span class="botimg"><img src="http://placehold.it/400x190" alt="" /></span>
    </div><!-- end section -->
...
<div class="container">
	...
	<h2 class="section_title_whitebig">Awesome Unique designs <strong>clean and beautiful</strong></h2>
    
	<p class="less1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Curabitur eget orci. Cras laoreet ligula.</p>
    <br /><br />
    <img src="images/site-img14.png" alt="" class="img_left" />
    
</div>
</div><!-- end features section13 -->
...
<div class="container">
	...
	<h2 class="section_title_drakgray"><strong>pricing</strong> tables</h2>
    ...
    <div class="pricings_home">
    	...
    	<ul>
            ...
            <li class="but"><a href="#" class="readmore_but3 nofloat">Order now</a></li>
        </ul>
    ...
    <div class="pricings_home">
    	...
    	<ul>
            ...
            <li>Free Domain Name</li>
            <li>Money back Guarantee</li>
            <li class="but"><a href="#" class="readmore_but3 active nofloat">Order now</a></li>
        </ul>
    ...
    <p class="less2">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis 
commodo augue. Aliquam ornare hendrerit augue. Cras tellus pulvinar lectus.</p>
	<br /><br />
    
	<a href="#" class="readmore_but6">know more about pricings</a>
    
</div>
</div><!-- end features section14 -->
        ...
        <div class="flexslider carousel">
          <ul class="slides">
                ...
                <li>
                    ...
                    <br />
                    <h4>GSRthemes9 <em>- 4 days ago</em></h4>
                    
                    <p class="less1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Curabitur eget orci. Cras laoreet ligula. Etiam sit amet dolor.</p>
                    <br /><br />
                    <a href="https://twitter.com/gsrthemes9" target="_blank" class="readmore_but7">Follow Us</a>
                    <br /><br />
                </li><!-- end section -->
                ...
                <li>
                    <i class="fa fa-twitter"></i>
                    <br />
                    <h4>GSRthemes9 <em>- 5 days ago</em></h4>
                ...
                <li>
                    <i class="fa fa-twitter"></i>
                    <br />
                    <h4>GSRthemes9 <em>- 9 days ago</em></h4>
                ...
                <li>
                    <i class="fa fa-twitter"></i>
                    <br />
                    <h4>GSRthemes9 <em>- 13 days ago</em></h4>
...
<div class="features_sec19">
<div class="container">
	
	<h2 class="section_title_drakgray"><strong>what you get</strong> WITH elos</h2>
    ...
    <div class="left">
        ...
        <ul>
            ...
            <li>
            <h3>RESPONSIVE</h3></li>
            <li><p>Contrary to popular a belief, Lorem Ipsum is not simply It has literature Richard.</p></li>
		</ul>
        ...
        <ul>
            ...
            <li>
            <h3 class="nocaps">Unique Design</h3></li>
            <li><p>Contrary to popular a belief, Lorem Ipsum is not simply It has literature Richard.</p></li>
		</ul>
              
    </div><!-- end section -->
    
    <div class="center"></div><!-- end center image -->
	...
	<div class="right">
        ...
        <ul>
            ...
            <li>
            <h3 class="nocaps">Slide Shows</h3></li>
            <li><p>Contrary to popular a belief, Lorem Ipsum is not simply It has literature Richard.</p></li>
		</ul>
...
<div class="container">
	...
	<div class="one_fourth">
    	...
    	<!-- section 1 -->
        <span class="acc-trigger active"><a href="#">Who we are?</a></span>
        <div class="acc-container">
        <div class="content">
        There are many variations of passages available but the majority have alteration
        </div>
        </div>
      
        <!-- section 2 -->
        <span class="acc-trigger"><a href="#">What we do?</a></span>
        <div class="acc-container">
        <div class="content">
        Some form, by injected humour, or randomised words which looks.
        </div>
        </div>
...
<div class="container">
    ...
    <div class="one_half"><img src="http://placehold.it/530x430" alt="" class="img_left" /></div><!-- end left image -->
    ...
    <div class="one_half last">
    	...
    	<ul class="active">
            ...
            <li class="text"><h3 class="nocaps">Want to Improve Business</h3> <p>It was popularised in the with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software many web sites still in their infancy.</p></li>
        </ul>
        ...
        <ul>
            ...
            <li class="text"><h3 class="nocaps">Start a Business Thinking</h3> <p>It was popularised in the with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software many web sites still in their infancy.</p></li>
        </ul>
...
<div class="features_sec22">
<div class="container">

	<h2 class="section_title_drakgray"><strong>what</strong> we do?</h2>
...
<div class="container">
	...
	<div class="latestnews">
        ...
        <ul class="news">
        	<li class="left"><a href="#"><img src="http://placehold.it/110x110" alt="" /></a></li>
            <li><h5><a href="#">elos Responsive</a></h5> <i class="fa fa-clock-o"></i> Feb 18, 2014 &nbsp;&nbsp;<i class="fa fa-comment"></i> 13</li>
        </ul>
         
        <ul class="news active">
        	<li class="left"><a href="#"><img src="http://placehold.it/110x110" alt="" /></a></li>
            <li><h5><a href="#">Creative Designs</a></h5> <i class="fa fa-clock-o"></i> Feb 17, 2014 &nbsp;&nbsp;<i class="fa fa-comment"></i> 13</li>
        </ul>
        
		<ul class="news">
        	<li class="left"><a href="#"><img src="http://placehold.it/110x110" alt="" /></a></li>
            <li><h5><a href="#">creative media</a></h5> <i class="fa fa-clock-o"></i> Feb 16, 2014 &nbsp;&nbsp;<i class="fa fa-comment"></i> 13</li>
        </ul>
        
        <div class="clearfix margin_top3"></div>
        
        <a href="#" class="readmore_but8">MORE News <i class="fa fa-long-arrow-right"></i></a>
        
    </div><!-- end news -->
    
    <div class="latestblogs">
    	
        <h2 class="section_title_drakgray left">Latest From Blog</h2>
        
        <ul class="hblogs">
        	<li class="image"><img src="http://placehold.it/720x215" alt="" /></li>
            <li class="date"><strong>18</strong> feb</li>
            <li class="title"><h2 class="nocaps"><a href="#" class="two">Morlem ipsum dolor sit amet</a></h2> by <a href="#" class="three">David witts</a> in <a href="#" class="three">News</a></li>
            <li class="text"><p>Morlem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa nulla consequat massa quis enim Donec pede justo, fringilla vel, aliquet nec.</p></li>
            <li><br /><a href="#" class="readmore_but8">All Blogs <i class="fa fa-long-arrow-right"></i></a></li>
        </ul>
...
<div class="container">
     ...
     <h2 class="section_title_white fure"><strong>what our</strong> clints says</h2>
    ...
    <section class="slider nosidearrows_two">
        <div class="flexslider carousel">
            <ul class="slides">
                ...
                <li>
                	<div class="left"><img src="http://placehold.it/173x154" alt="" class="client_img" /><h5 class="nocaps">Marry John <em>- Mediatricks</em></h5></div>
                    <div class="right">Etiam dictum. Nunc enim. Sed massa tellus, aliquam rhoncus, venenatis quis, suscipit ac, libero. Praesent odio tellus, posuere sed, dictum sed, fermentum at, orci. Aenean arcu tortor, suscipit vitae, hendrerit condimentum, dapibus ac, nulla. Curabitur tempor. Donec dapibus placerat ipsum. Nulla facilisi. Aliquam ut leo quis nunc adipiscing faucibus. Mauris non quam ac eros rutrum fringilla. Quisque ut turpis. Nullam rhoncus feugiat quam. Nunc enim nibh, fermentum sed, lobortis ac, pellentesque ut, velit. Donec pretium, felis eget ultrices rhoncus, dui lacus convallis tortor, at mollis erat risus ac dui.</div>
                </li><!-- end section -->
                
                <li>
                	<div class="left"><img src="http://placehold.it/173x154" alt="" class="client_img" /><h5 class="nocaps">Joan Collins <em>- Masterminds</em></h5></div>
                    <div class="right">Etiam dictum. Nunc enim. Sed massa tellus, aliquam rhoncus, venenatis quis, suscipit ac, libero. Praesent odio tellus, posuere sed, dictum sed, fermentum at, orci. Aenean arcu tortor, suscipit vitae, hendrerit condimentum, dapibus ac, nulla. Curabitur tempor. Donec dapibus placerat ipsum. Nulla facilisi. Aliquam ut leo quis nunc adipiscing faucibus. Mauris non quam ac eros rutrum fringilla. Quisque ut turpis. Nullam rhoncus feugiat quam. Nunc enim nibh, fermentum sed, lobortis ac, pellentesque ut, velit. Donec pretium, felis eget ultrices rhoncus, dui lacus convallis tortor, at mollis erat risus ac dui.</div>
                </li><!-- end section -->
                
                <li>
                	<div class="left"><img src="http://placehold.it/173x154" alt="" class="client_img" /><h5 class="nocaps">Alphonse Ria <em>- Mediatricks</em></h5></div>
                    <div class="right">Etiam dictum. Nunc enim. Sed massa tellus, aliquam rhoncus, venenatis quis, suscipit ac, libero. Praesent odio tellus, posuere sed, dictum sed, fermentum at, orci. Aenean arcu tortor, suscipit vitae, hendrerit condimentum, dapibus ac, nulla. Curabitur tempor. Donec dapibus placerat ipsum. Nulla facilisi. Aliquam ut leo quis nunc adipiscing faucibus. Mauris non quam ac eros rutrum fringilla. Quisque ut turpis. Nullam rhoncus feugiat quam. Nunc enim nibh, fermentum sed, lobortis ac, pellentesque ut, velit. Donec pretium, felis eget ultrices rhoncus, dui lacus convallis tortor, at mollis erat risus ac dui.</div>
                </li><!-- end section -->
...
<div class="features_sec26">
<div class="container">

	<h2 class="section_title_drakgray"><strong>meet</strong> Our Team</h2>
    
    <div class="one_third">
    <div class="box">
    	
		<img src="http://placehold.it/370x265" alt="" />
...
<div class="features_sec27">
<div class="container">
	
	<div class="one_half">
    
    	<h2 class="section_title_drakgray left">from the blog</h2>
        
        <div class="one_half">
        	
			<ul class="blogs2">
            	<li><a href="#"><img src="http://placehold.it/270x210" alt="" /></a></li>
                <li><h4 class="nocaps"><a href="#" class="two">Responsive Design</a></h4></li>
                <li><i class="fa fa-clock-o"></i> Feb 18, 2014 &nbsp;&nbsp;<i class="fa fa-user"></i> Admin &nbsp;&nbsp;<i class="fa fa-comment"></i> 9</li>
            </ul>
        ...
        <div class="one_half last">
			...
			<ul class="blogs2">
            	<li><a href="#"><img src="http://placehold.it/270x210" alt="" /></a></li>
                <li><h4 class="nocaps"><a href="#" class="two">Succcess your business</a></h4></li>
                <li><i class="fa fa-clock-o"></i> Feb 17, 2014 &nbsp;&nbsp;<i class="fa fa-user"></i> Admin &nbsp;&nbsp;<i class="fa fa-comment"></i> 8</li>
            </ul>
    ...
    <div class="one_half last">
        ...
        <ul class="news2">
        	<li class="date"><strong>18</strong> Feb</li>
            <li class="text"><h4 class="nocaps">elos multipurpose theme</h4> 4 comments
            <p>Lorem ipsum dolor sit amet consectetuer adipiscing elit Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit  Lorem ipsum dolor sit amet consectetuer adipiscing elit.</p>
            </li>
		</ul>
        
        <ul class="news2 last">
        	<li class="date"><strong>17</strong> Feb</li>
            <li class="text"><h4 class="nocaps">Unique Designs</h4> 1 comments
            <p>Lorem ipsum dolor sit amet consectetuer adipiscing elit Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit  Lorem ipsum dolor sit amet consectetuer adipiscing elit.</p>
            </li>
		</ul>
...
<div class="container">
	...
	<h2 class="section_title_drakgray"><strong>Awesome</strong> features</h2>
    
    <div class="one_third">
    <div class="box">
    	
		<img src="http://placehold.it/367x157" alt="" />
        
		<h3>Fast and Light Weight</h3>
        
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor ut labore.</p>
        <br />
        <a href="#" class="readmore_but11"><i class="fa fa-location-arrow"></i> Read more</a>
...
<div class="container">
	...
	<h2 class="section_title_drakgray"><strong>best</strong> features</h2>
...
<div class="container">
    ...
    <div class="hvideo"><iframe src="http://www.youtube.com/embed/a49Tn9iRpWQ" frameborder="0" allowfullscreen></iframe></div>
    
</div>
</div><!-- end features section30 -->
...
<div class="container">
    ...
    <div class="one_half"><img src="images/site-img36.png" alt="" class="img_left" /></div>
    
    <div class="one_half last">
    	
        <h2 class="section_title_drakgray left"><strong>Core</strong> Features</h2>
        ...
        <a href="#" class="readmore_but3"><i class="fa fa-arrow-circle-right"></i>&nbsp; View All</a>
...
<div class="container">
	...
	<h2 class="section_title_white fure lessmar"><strong>Testimonials</strong> &amp; Clients</h2>
    
    <p class="less1 white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Curabitur eget orci. Cras laoreet ligula. Etiam sit amet dolor.</p>
    ...
    <div class="one_half">
        ...
        <div class="flexslider carousel">
            <ul class="slides">
                ...
                <li>
                	<div class="left"><div class="cimage"></div></div>
                    <div class="right">Lorem ipsum dolor sit amet, consectetuer adipiscing justo Praesent mattis commodo. <h5>John Smith <em>Manager - <b>Media Inc</b></em></h5></div>
                </li><!-- end section -->
                
                <li>
                	<div class="left"><div class="cimage two"></div></div>
                    <div class="right">Lorem ipsum dolor sit amet, consectetuer adipiscing justo Praesent mattis commodo. <h5>Alphonse Ria <em>Support - <b>Media Inc</b></em></h5></div>
                </li><!-- end section -->
                
                <li>
                	<div class="left"><div class="cimage three"></div></div>
                    <div class="right">Lorem ipsum dolor sit amet, consectetuer adipiscing justo Praesent mattis commodo. <h5>Joan Collins <em>Develop - <b>Media Inc</b></em></h5></div>
                </li><!-- end section -->
    ...
    <div class="one_half last">
        ...
        <ul class="clients">
        	<li><img src="images/client-logo1-white.png" alt="" /></li>
            <li><img src="images/client-logo2-white.png" alt="" /></li>
            <li><img src="images/client-logo3-white.png" alt="" /></li>
            <li><img src="images/client-logo4-white.png" alt="" /></li>
            <li><img src="images/client-logo5-white.png" alt="" /></li>
            <li><img src="images/client-logo6-white.png" alt="" /></li>
		</ul>
        
    </div><!-- end clients -->
    
</div>
</div><!-- end features section32 -->

<div class="clearfix"></div>

<div class="features_sec33">
<div class="container">
	
    <div class="leftimg"><img src="images/site-img38.png" alt="" class="img_left" /></div>
    
    <div class="right">
    
    	<h2 class="section_title_drakgray bline"><strong>Responsive</strong> design</h2>
        
    	<ul class="active">
        	<li class="icon"><i class="fa fa-globe"></i></li>
            <li class="text"><h4 class="nocaps">Cross Browser Compatibility</h4> <p>It was popularised in the with the release etraset sheets containing Ipsum passages, and more recently with desktop infancy.</p></li>
        </ul>
        ...
        <ul>
            ...
            <li class="text"><h4 class="nocaps">Clean &amp; Modern Design</h4> <p>It was popularised in the with the release etraset sheets containing Ipsum passages, and more recently with desktop infancy.</p></li>
        </ul>
        ...
        <ul>
        	<li class="icon"><i class="fa fa-cog"></i></li>
            <li class="text"><h4 class="nocaps">jQuery Enhancements</h4> <p>It was popularised in the with the release etraset sheets containing Ipsum passages, and more recently with desktop infancy.</p></li>
        </ul>
        
		<a href="#" class="readmore_but12">Read more</a> &nbsp; <a href="#" class="readmore_but12">Buy now!</a>
          
    </div>
      
</div>
</div><!-- end features section33 -->

<div class="clearfix"></div>

<div class="features_sec34">
<div class="container">
...
</div><!-- end features section34 -->

<div class="clearfix"></div>

<div class="features_sec35">
<div class="container">
    ...
    <div class="box">
		...
		<div class="timage"><img src="images/site-img43.png" alt="" /></div>
    ...
    <div class="box active">
		...
		<div class="timage"><img src="images/site-img42.png" alt="" /></div>
    ...
    <div class="box">
		...
		<div class="timage"><img src="images/site-img41.png" alt="" /></div>
    ...
    <div class="box">
		...
		<div class="timage"><img src="images/site-img44.png" alt="" /></div>
...
<div class="container">
     ...
     <h1>Join The elos and Get Lots of Awesome Features</h1>
     <h4>Theme Can be Used for Any Type of Website. Complete Package of elos. We hope that you enjoy it.</h4>
     <br />
     
     <a href="#" class="readmore_but13">purchase now <i class="fa fa-arrow-circle-right"></i></a>
...
<div class="container">
	...
	<h2 class="section_title_drakgray"><strong>Skills</strong> &amp; Services</h2>
    ...
    <div class="two_third">
        ...
        <div id="example-3-tab-1" class="tabs-panel3">
            <img src="http://placehold.it/205x115" alt="" class="img_left2" />
        ...
        <div id="example-3-tab-3" class="tabs-panel3">
			<img src="http://placehold.it/270x210" alt="" class="img_left2" />
         	<p>Development dolor sit amet, consectetur adipiscing elit. Phasellus ac fringilla nulla, sit amet consequat eros. Pellentesque pharetra blandit commodo. Phasellus massa nisl, feugiat ac bibendum et, dictum id ipsum. Quisque sit amet accumsan tortor It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged many web sites still in their infanc versions have evolved over the years. the Internet tend to repeat predefined chunks as necessary, making this the first true randomised words which generator on the Internet.</p>
        </div><!-- end tab 3 -->
        
        <div id="example-3-tab-4" class="tabs-panel3">
            <img src="http://placehold.it/367x157" alt="" class="img_left2" />
             <p>Development dolor sit amet, consectetur adipiscing elit. Phasellus ac fringilla nulla, sit amet consequat eros. Pellentesque pharetra blandit commodo. Phasellus massa nisl, feugiat ac bibendum et, dictum id ipsum. Quisque sit amet accumsan tortor It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged many web sites still in their infanc versions have evolved over the years. the Internet tend to repeat predefined chunks as necessary, making this the first true randomised words which generator on the Internet.</p>
        </div><!-- end tab 4 -->
...
<div class="container">
    ...
    <div class="twitter_feed">
        ...
        <div class="right"><a href="https://twitter.com/gsrthemes9" target="_blank">gsrthemes9</a>: Liwo - Responsive Template on ThemeForest.<br />
        ...
        <div class="left"><i class="fa fa-twitter fa-lg"></i></div>
        <div class="right"><a href="https://twitter.com/gsrthemes9" target="_blank">gsrthemes9</a>: Joosa - Responsive HTML5 / CSS3, Corporate Theme.<br />
    ...
    <div class="newsletter">
        ...
        <input class="enter_email_input" name="samplees" id="samplees" value="E-mail Address" onFocus="if(this.value == 'E-mail Address') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'E-mail Address';}" type="text">
            ...
            <input name="" value="Go" class="input_submit" type="submit">
        </form>
...
<script type="text/javascript" src="web/js/universal/jquery.js"></script>

<!-- style switcher -->
<script src="web/js/style-switcher/jquery-1.js"></script>
<script src="web/js/style-switcher/styleselector.js"></script>

<!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
<script type="text/javascript" src="web/js/revolutionslider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="web/js/revolutionslider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

<!-- mega menu -->
<script src="web/js/mainmenu/bootstrap.min.js"></script>
<script src="web/js/mainmenu/fhmm.js"></script>
...
<!-- tabs -->
<script src="web/js/tabs/assets/js/responsive-tabs.min.js" type="text/javascript"></script>
...
<!-- accordion -->
<script type="text/javascript" src="web/js/accordion/custom.js"></script>

<!-- REVOLUTION SLIDER -->
<script type="text/javascript" src="web/js/revolutionslider/rs-plugin/js/custom2.js"></script>

<!-- sticky menu -->
<script type="text/javascript" src="web/js/mainmenu/sticky.js"></script>
<script type="text/javascript" src="web/js/mainmenu/modernizr.custom.75180.js"></script>

<!-- progress bar -->
<script src="web/js/progressbar/progress.js" type="text/javascript" charset="utf-8"></script>
...
<!-- cubeportfolio -->
<script type="text/javascript" src="web/js/cubeportfolio/jquery.cubeportfolio.min.js"></script>
<script type="text/javascript" src="web/js/cubeportfolio/main.js"></script>

<!-- carousel -->
<script defer src="web/js/carousel/jquery.flexslider.js"></script>
<script defer src="web/js/carousel/custom.js"></script>
